...
require (
	github.com/dolthub/go-mysql-server v0.12.1-0.20220720194123-36df39eb17ed
...
replace github.com/dolthub/go-mysql-server => /Users/jenniferpurevsuren/dolt_workspace/go-mysql-server
